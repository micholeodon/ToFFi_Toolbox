...
VERSION=YYYY-MM-DD
TAG=SF_3.0_illustrative_serial
DATE=`date +'%Y-%m-%d-%H:%M'`
...
G_maxNumSpmdWorkers=1


### STAGE 1 ###
S1_MODE='serial' # 'serial' or 'parallel'
...
### STAGE 2 ###
S2_MODE='serial' # 'serial' or 'parallel'
...
### STAGE 4 ###
S4_MODE='serial' # 'serial' or 'parallel'
...
### STAGE 6 ###
S6_MODE='serial' # 'serial' or 'parallel'
...
### STAGE 7 ###
S7_MODE='serial' # 'serial' or 'parallel'
