...
VERSION=YYYY-MM-DD
TAG=SF_3.0_illustrative_SLURM
DATE=`date +'%Y-%m-%d-%H:%M'`
MATLAB_RUNPATH='/apl/tryton/matlab/R2021a/bin/matlab'
IS_LINUX=1; # =1 if you ar running Linux or =0 if other system
...
### GLOBAL PARAMETERS ###
G_rootDir='/users/johndoe/ToFFi_Toolbox-YYYYMMDD/' # absolute path !
G_veryFirstInputDataDir='/users/johndoe/HCP_data/' # absolute path !
...
G_fieldtripPath='/users/johndoe/fieldtrip-20210816/' # absolute path !
...
G_maxNumQueuedJobsPerUser=70
G_maxNumSpmdWorkers=24


### STAGE 1 ###
S1_MODE='parallel' # 'parallel' or 'parallel'
...
S7_SLURM_queueName='batch_16h'
S7_SLURM_nTasksPerNode=24
S7_SLURM_mem=128000
S7_SLURM_time='00:30:00'
